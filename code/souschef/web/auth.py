...
from souschef.database import get_connection, DictConnection

SESSION_COOKIE = "souschef_session"
SESSION_TTL_DAYS = 30
MAGIC_LINK_TTL_MINUTES = 15

RESEND_API_KEY = os.environ.get("RESEND_API_KEY", "")
RESEND_FROM = os.environ.get("RESEND_FROM", "souschef <noreply@souschef.app>")
